...
#=activities = [Activity(540,720),Activity(555,660),Activity(630,800),
			  Activity(690,810), Activity(795,900), Activity(825,855),Activity(840,960),
			  Activity(960,1020)]=#
#=activities = [Activity(540,720),Activity(630,800),
			  Activity(795,900), Activity(825,855)]=#
#activities = [Activity(630,800), Activity(825,855)]
n = length(activities)
